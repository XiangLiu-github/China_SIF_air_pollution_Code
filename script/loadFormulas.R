...
fml_inter_year <- str_c(
  "GOSIF_sum ~ ",
  c(
    str_c(c("new", "mid", "old"), "_AOD"), str_c(c("new", "mid", "old"), "_AOD2"), str_c(c("new", "mid", "old"), "_AOT40"), "cloud", "cloud^2",
    str_c("bin", 0:39),
    str_c("surface_", 1:9)
  ) %>%
    str_flatten(collapse = "+"), "| x_y[year]"
...
fml_inter_region <- str_c(
  "GOSIF_sum ~ ",
  c(
    str_c("R", 1:4, "_AOD"), str_c("R", 1:4, "_AOD2"), str_c("R", 1:4, "_AOT40"), "cloud", "cloud^2",
    str_c("bin", 0:39),
    str_c("surface_", 1:9)
  ) %>%
    str_flatten(collapse = "+"), "| x_y[year]"
...
fml_inter_region_rice <- str_c(
  "GOSIF_sum ~ ",
  c(
    str_c("R", 1:5, "_AOD"), str_c("R", 1:5, "_AOD2"), str_c("R", 1:5, "_AOT40"), "cloud", "cloud^2",
    str_c("bin", 0:39),
    str_c("surface_", 1:9)
  ) %>%
    str_flatten(collapse = "+"), "| x_y[year]"
...
fml_inter_full <- str_c(
  "GOSIF_sum ~ ",
  c(
    str_c("R", 1:4, "_AOD"), str_c("R", 1:4, "_AOD2"),
    str_c(c(
      "AOT40", "cloud", "cloud^2",
      str_c("bin", 0:39),
      str_c("surface_", 1:9)
...
fml_inter_full_rice <- str_c(
  "GOSIF_sum ~ ",
  c(
    str_c("R", 1:5, "_AOD"), str_c("R", 1:5, "_AOD2"),
    str_c(c(
      "AOT40", "cloud", "cloud^2",
      str_c("bin", 0:39),
      str_c("surface_", 1:9)
