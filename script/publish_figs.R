...
c(
  ...
  "figures/hist_impact_map_hete.pdf",
  "figures/hist_impact_fig3_hete.pdf",
  "figures/hist_impact_fig4_hete.pdf"
) %>%
...
c(
  ...
  "figures/ozone_validation.pdf",
  "figures/province_SIF_validation.pdf",
  "figures/province_NIRv_validation.pdf",
  ...
  "figures/response_radiation_Jiang.pdf",
  "figures/response_radiation_Chakraborty.pdf",
  "figures/Step_2_counterfactual_air_pollution_level.pdf",
  # "figures/compare_sensitivity.pdf",
  "figures/response_hete_irrigation.pdf",
  "figures/response_hete_vpd.pdf",
  "figures/response_hete_spatial.pdf",
  "figures/response_hete_temporal.pdf",
  "figures/counterfactual_map.pdf",
  "figures/hist_impact_map.pdf",
  "figures/hist_impact_fig3.pdf",
  "figures/hist_impact_fig4.pdf",
  "figures/hist_impact_fig4_w126.pdf",
