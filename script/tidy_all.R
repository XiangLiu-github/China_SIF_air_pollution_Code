...
MAIAC <- read_rds("data/outputs/aerosol/MAIAC.rds") # 2000-2020
...
BaRAD <- read_rds("data/outputs/radiation/tidied_BaRAD.rds") # 2005-2019
...
fnl_data <-
  ...
  summarise(
    ...
    across(c(
      maxtmp, cloud, vpd_mean,
      AOD, PM25, PM10, NO2, MAIAC,
      HE, MA, `GR&EM`, down, diff, dir,
      GOSIF, Wenetal, RTSIF, CSIF,
      NIRv, NIRvc, NDVI, EVI,
...
qsave(fnl_data, "data/tidied.qs", nthreads = 10)
