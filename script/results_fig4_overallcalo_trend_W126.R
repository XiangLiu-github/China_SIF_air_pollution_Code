...
aerosol <- qread("data/impacts_aerosol_W126.qs", nthreads = qn)
...
ozone <- qread("data/impacts_ozone_W126.qs", nthreads = qn)
...
ggsave("figures/hist_impact_fig4_w126.pdf", patch, width = 3, height = 2.5, scale = 4)
